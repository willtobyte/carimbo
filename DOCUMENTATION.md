...
Well, in Carimbo, there’s an interface for reading and writing the game’s state in a key-value format to a `cassette.tape` file, or to a cookie when running on the web.
