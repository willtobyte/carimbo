...
void framework::scriptengine::run() {
  ...
  lua["require"] = [&lua](const std::string &module) { return require(lua, module); };
  ...
  lua.new_usertype<audio::soundmanager>(
      "SoundManager", "play", &audio::soundmanager::play, "stop", &audio::soundmanager::stop
  );

  lua.new_enum(
      "Controller", "up", input::joystickevent::up, "down", input::joystickevent::down, "left",
      input::joystickevent::left, "right", input::joystickevent::right, "triangle", input::joystickevent::triangle,
      "circle", input::joystickevent::circle, "cross", input::joystickevent::cross, "square",
      input::joystickevent::square
  );

  lua.new_enum(
      "Anchor", "top", framework::anchor::top, "bottom", framework::anchor::bottom, "left", framework::anchor::left,
      "right", framework::anchor::right, "none", framework::anchor::none
  );

  lua.new_enum(
      "Reflection", "none", graphics::reflection::none, "horizontal", graphics::reflection::horizontal, "vertical",
  ...
  lua.new_usertype<reflectionproxy>("ReflectionProxy", "set", &reflectionproxy::set, "unset", &reflectionproxy::unset);
  ...
  lua.new_usertype<actionproxy>(
      "ActionProxy", "set", &actionproxy::set, "get", &actionproxy::get, "unset", &actionproxy::unset
  );
  ...
  lua.new_usertype<placementproxy>("PlacementProxy", "set", &placementproxy::set, "get", &placementproxy::get);
  ...
  lua.new_usertype<velocityproxy>(
      "VelocityProxy", "set", &velocityproxy::set, "get", &velocityproxy::get, "x",
      sol::property(&velocityproxy::get_x, &velocityproxy::set_x), "y",
      sol::property(&velocityproxy::get_y, &velocityproxy::set_y)
  );

  lua.new_usertype<memory::kv>(
      "KeyValue", "get",
      [](memory::kv &self, const std::string &key, sol::this_state state) { return self.get(key, state); }, "set",
      [](memory::kv &self, const std::string &key, const sol::object &new_value, sol::this_state state) {
        self.set(key, new_value, state);
      },
      "subscribe",
      [](memory::kv &self, const std::string &key, const sol::function &callback, sol::this_state state) {
        self.subscribe(key, callback, state);
      }
  );

  lua.new_usertype<framework::entity>(
      "Entity", sol::no_constructor, "id", sol::property(&framework::entity::id), "x",
      sol::property(&framework::entity::x), "y", sol::property(&framework::entity::y), "visible",
      sol::property(&framework::entity::visible), "move", &framework::entity::move, "on_update",
      &framework::entity::set_onupdate, "on_animationfinished", &framework::entity::set_onanimationfinished, "on_mail",
      &framework::entity::set_onmail, "on_touch", &framework::entity::set_ontouch, "on_collision",
      &framework::entity::set_oncollision, "reflection",
      sol::property([](framework::entity &e) -> reflectionproxy { return reflectionproxy{e}; }), "action",
      sol::property([](framework::entity &e) -> actionproxy { return actionproxy{e}; }), "placement",
      sol::property([](framework::entity &e) -> placementproxy { return placementproxy{e}; }), "velocity",
      sol::property([](framework::entity &e) -> velocityproxy { return velocityproxy{e}; }), "kv",
      sol::property([](framework::entity &e) -> memory::kv & { return e.kv(); })
  );

  lua.new_usertype<framework::entitymanager>(
      "EntityManager", "spawn", &framework::entitymanager::spawn, "clone", &framework::entitymanager::clone, "destroy",
      &framework::entitymanager::destroy
  );

  lua.new_usertype<framework::resourcemanager>(
      "ResourceManager", "flush", &framework::resourcemanager::flush, "prefetch",
  ...
  struct playerwrapper {
    ...
    bool on(std::variant<input::joystickevent> type) { return e.on(index, type); }
  };

  lua.new_usertype<playerwrapper>("PlayerWrapper", sol::no_constructor, "on", &playerwrapper::on);
  ...
  lua.new_usertype<framework::statemanager>(
      "StateManager", sol::no_constructor, "collides", &statemanager::collides, "players",
      sol::property(&statemanager::players), "player",
      [&_p](framework::statemanager &self, input::player player) -> playerwrapper & {
  ...
  lua.new_usertype<framework::scenemanager>(
      "SceneManager", sol::no_constructor, "set", &framework::scenemanager::set, "grab", &framework::scenemanager::grab
  );

  lua.new_enum("WidgetType", "cursor", graphics::widgettype::cursor, "label", graphics::widgettype::label);
  ...
  lua.new_usertype<graphics::overlay>(
      "Overlay", "create", &graphics::overlay::create, "destroy", &graphics::overlay::destroy, "dispatch",
      &graphics::overlay::dispatch, "cursor",
      sol::property([](graphics::overlay &o) -> cursorproxy { return cursorproxy{o}; })
  );

  lua.new_usertype<framework::engine>(
      "Engine", "add_loopable", &framework::engine::add_loopable, "canvas", &framework::engine::canvas, "cassete",
      &framework::engine::cassete, "entitymanager", &framework::engine::entitymanager, "fontfactory",
      &framework::engine::fontfactory, "overlay", &framework::engine::overlay, "resourcemanager",
      &framework::engine::resourcemanager, "soundmanager", &framework::engine::soundmanager, "statemanager",
      &framework::engine::statemanager, "scenemanager", &framework::engine::scenemanager, "run", &framework::engine::run
  );

  lua.new_usertype<graphics::font>("Font", sol::no_constructor);

  lua.new_usertype<framework::enginefactory>(
      "EngineFactory", sol::constructors<framework::enginefactory()>(), "with_title",
      &framework::enginefactory::with_title, "with_width", &framework::enginefactory::with_width, "with_height",
      &framework::enginefactory::with_height, "with_scale", &framework::enginefactory::with_scale, "with_gravity",
      &framework::enginefactory::with_gravity, "with_fullscreen", &framework::enginefactory::with_fullscreen, "create",
      &framework::enginefactory::create
  );

  lua.new_usertype<geometry::point>(
      "Point", sol::constructors<geometry::point(), geometry::point(int32_t, int32_t)>(), "set", &geometry::point::set,
      "x", sol::property(&geometry::point::x, &geometry::point::set_x), "y",
      sol::property(&geometry::point::y, &geometry::point::set_y), sol::meta_function::to_string,
      [](const geometry::point &p) { return "point(" + std::to_string(p.x()) + ", " + std::to_string(p.y()) + ")"; }
  );
  ...
  lua.new_usertype<geometry::size>(
      ...
      "width", sol::property(&geometry::size::width, &geometry::size::set_width), "height",
      sol::property(&geometry::size::height, &geometry::size::set_height)
  );

  lua.new_usertype<storage::cassete>(
      "Cassete", sol::no_constructor, "set",
      [](storage::cassete &c, const std::string &key, sol::object object) {
        if (object.is<int>())
      ...
      "get",
      [](const storage::cassete &c, const std::string &key, sol::this_state ts) -> sol::object {
  ...
  lua.new_usertype<network::socket>(
      "Socket", sol::constructors<network::socket()>(), "connect", &network::socket::connect, "emit",
      [](network::socket &sio, const std::string &event, sol::table data, sol::this_state state) {
        sol::state_view lua(state);
        const auto j = _to_json(data);
        sio.emit(event, j.dump());
      },
      "on",
      [](network::socket &sio, const std::string &event, sol::function callback, sol::this_state state) {
        sol::state_view lua(state);
      ...
      "rpc",
      [](network::socket &sio, const std::string &method, sol::table arguments, sol::function callback,
  ...
  lua.new_usertype<graphics::color>(
      "Color", "color", sol::constructors<graphics::color(const std::string &)>(),
      ...
      &graphics::color::operator==, // sol::meta_function::not_equal_to, &color::operator!=,

      sol::meta_function::to_string,
      [](const graphics::color &c) {
        return "color(" + std::to_string(c.r()) + ", " + std::to_string(c.g()) + ", " + std::to_string(c.b()) + ", " +
               std::to_string(c.a()) + ")";
      }
  );

  lua.new_enum(
      "KeyEvent", "up", input::keyevent::up, "left", input::keyevent::left, "down", input::keyevent::down, "right",
      input::keyevent::right, "space", input::keyevent::space
  );

  lua.new_usertype<framework::mail>(
      "Mail",
      sol::constructors<
          framework::mail(std::shared_ptr<framework::entity>, std::shared_ptr<framework::entity>, const std::string &)>(
      )
  );

  lua.new_usertype<framework::postalservice>(
      "PostalService", sol::constructors<framework::postalservice()>(), "post", &framework::postalservice::post
  );

  lua.new_usertype<framework::timermanager>(
      "TimeManager", sol::constructors<framework::timermanager()>(), "set", &framework::timermanager::set, "singleshot",
      &framework::timermanager::singleshot, "clear", &framework::timermanager::clear
  );
  ...
  lua.new_usertype<algebra::vector2d>(
      ...
      sol::property(&algebra::vector2d::y, &algebra::vector2d::set_y), "set", &algebra::vector2d::set,

      "magnitude", &algebra::vector2d::magnitude, "unit", &algebra::vector2d::unit, "dot", &algebra::vector2d::dot,

      sol::meta_function::addition, &algebra::vector2d::operator+, sol::meta_function::subtraction,
      &algebra::vector2d::operator-,

      "add_assign", &algebra::vector2d::operator+=, "sub_assign", &algebra::vector2d::operator-=, "mul_assign",
      &algebra::vector2d::operator*=, "div_assign", &algebra::vector2d::operator/=,

      sol::meta_function::equal_to, &algebra::vector2d::operator==,

      "zero", &algebra::vector2d::zero, "moving", &algebra::vector2d::moving, "right", &algebra::vector2d::right,
      "left", &algebra::vector2d::left
  );

  lua.new_usertype<graphics::label>(
      "Label", sol::constructors<graphics::label()>(), sol::base_classes, sol::bases<graphics::widget>(), "font",
      sol::property(&graphics::label::set_font), "set",
      sol::overload(
          [](graphics::label &self, const std::string &text) { self.set(text); },
  ...
  lua.new_usertype<graphics::fontfactory>("FontFactory", "get", &graphics::fontfactory::get);
