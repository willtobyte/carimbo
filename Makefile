...
configure: clean ## Configure
	...
	cmake -S . -B build -DCMAKE_TOOLCHAIN_FILE=conan_toolchain.cmake -DSDL2_DIR=generators -DCMAKE_BUILD_TYPE=Release -DLOCAL=ON -DHITBOX=OFF -DSANDBOX=ON -DENABLE_PROFILING=OFF
